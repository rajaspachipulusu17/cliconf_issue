...
from ansible.module_utils.network.netvisor.netvisor import load_config, get_capabilities
#from ansible.module_utils.network.netvisor.netvisor import get_config, load_config
...
#        out = out.split()
    ...
    s = 'vrouter-interface-show'
    out = run_commands(module, s)[1]
    f = open("/tmp/vrou.txt", "a")
    f.write("output = %s\n" % out)
    f.close()
